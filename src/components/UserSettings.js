...
const UserSettings = () => {
  ...
  return (
    <ThemeProvider theme={darkTheme}>
      <CssBaseline />
      <Box sx={{ padding: 2, width: '100%', marginLeft: 8 }}>
        {/* Instructions on how to sign up for Alpaca and generate API keys */}
        <Typography variant="h4" gutterBottom color="primary.main" align="center">
          How to Sign Up for Alpaca and Generate API Keys:
        </Typography>
        <Typography variant="body1" sx={{ marginLeft: 2, marginTop: 4 }} >
          Step 1: Go to the Alpaca Markets website <a href="https://alpaca.markets/" target="_blank" rel="noopener noreferrer">https://alpaca.markets/</a> Signup for free and verify your account.
        </Typography>
        <Box sx={{ display: 'flex', justifyContent: 'center' }}>
          <img
            src="https://miro.medium.com/v2/resize:fit:1400/format:webp/1*AP8mWEIQTxUQEX_WsXQiAQ.png"
            alt="Alpaca Login Screenshot"
            style={{ width: '80%', height: 'auto', marginBottom: '20px', marginTop : '30px' }}
          />
        </Box>
        <Typography variant="body1" sx={{ marginLeft: 2, marginTop: 4 }}>
        ...
        <Box sx={{ display: 'flex', justifyContent: 'center' }}>
          <img
            ...
            style={{ width: '50%', height: 'auto', marginBottom: '20px' , marginTop : '30px'}}
          />
        </Box>
        <Typography variant="body1" sx={{ marginLeft: 2, marginTop: 4 }} >
          Step 5: Once you generate the API Keys, an API Key ID and Secret Key will appear.
          <br /><br />
          <strong>Please copy both of these into the form fields and save them.</strong>
          <br />
        </Typography>
